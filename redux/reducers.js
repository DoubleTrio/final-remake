...
const entityTypeReducer = (state = 'city', action) => {
  switch (action.type) {
...
const restaurantDataReducer = (state = {
  data: {}, success: null, error: null, waiting: null, loadedMore: null,
}, action) => {
  switch (action.type) {
...
const locationDataReducer = (state = {
  data: [], success: null, error: null, waiting: null,
}, action) => {
  switch (action.type) {
